...
void sumExactly(vector<int> &v, int userValue)
{
    int left_ptr = 0;
    ...
    {
        if (v[left_ptr] + v[right_ptr] > userValue)
        {
            right_ptr--;
        }
        else if (v[left_ptr] + v[right_ptr] < userValue)
        {
            left_ptr++;
        }
        else if (v[left_ptr] + v[right_ptr] == userValue)
        {
            cout << "Yes" << endl;
            cout << v[left_ptr] << " + " << v[right_ptr] << " = " << userValue << endl;
            goto endProgram;
        }
    }
    cout << "No" << endl;
